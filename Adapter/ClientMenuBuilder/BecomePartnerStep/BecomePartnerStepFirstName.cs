...
namespace FloristAI.Adapter.ClientMenuBuilder.BecomePartner
{
    public class BecomePartnerStepFirstName : IStepFlowBuilder
    {
        ...
        public BecomePartnerStepFirstName(IUserService userService, ILocalizationService localizationService, IStepFlowProvider menuProvider)
        {
        ...
        public async Task<MessageResult> HandleInput(string input, long chatId)
        {
            ...
            var nextBuilder = _menuProvider.GetBuilder("become_partner_step_lastName");
