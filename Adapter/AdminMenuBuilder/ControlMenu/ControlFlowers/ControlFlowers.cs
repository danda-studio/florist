...
namespace FloristAI.Adapter.AdminMenuBuilder.ControlMenu.ControlFlowers
{
    public class ControlFlowers: IStepMenuBuilder
    {
        private readonly IUserService _userService;
        private readonly ILocalizationService _localizationService;
        private readonly IGoogleSheetsService _googleSheetsService;

        public ControlFlowers(IUserService userService, ILocalizationService localizationService, IGoogleSheetsService googleSheetsService)
        {
        ...
        public string Step => "control_flowers_admin";
        ...
        public async Task<List<MessageResult>> BuildMenu(long chatId)
        {
            ...
            var header = _localizationService.GetString("Control_Header_Flowers", user.LanguageCode);
            ...
            var keyboard = new[]
            {
                ...
                new[] { InlineKeyboardButton.WithCallbackData(_localizationService.GetString("Button_Save_Changes", user.LanguageCode), "step:save_changes_flowers_admin") },
