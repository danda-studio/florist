...
namespace FloristAI.Adapter.AdminMenuBuilder.ControlMenu.ControlBoutiques
{
    public class ControlBoutiques : IStepMenuBuilder
    {
        ...
        public string Step => "control_boutiques";
        ...
        public async Task<List<MessageResult>> BuildMenu(long chatId)
        {
            ...
            var keyboard = new[]
            {
                ...
                new[] { InlineKeyboardButton.WithCallbackData(_localizationService.GetString("Button_Save_Changes", user.LanguageCode), "step:save_changes_boutiques") },
